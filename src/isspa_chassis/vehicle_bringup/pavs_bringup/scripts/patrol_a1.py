...
class PAVS_CarPatrol():
    def __init__(self):
        ...
        self.dyn_client = dynamic_reconfigure.client.Client("PAVS01_CarPatrol", timeout=60)
        ...
        while not rospy.is_shutdown():
            ...
            if self.Joy_active or self.warning > 10:
                ...
                if self.Command == "Circle":
                    ...
                    #move_cmd.linear.x = self.Linear
                    move_cmd.linear.x = self.Linear
                    #move_cmd.angular.z = copysign(abs(length), error)*5
