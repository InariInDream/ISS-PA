...
namespace global_motion_planner
{
  ...
  public:
     ...
     */
    PSO(int nx, int ny, double resolution, double origin_x, double origin_y, int n_particles,int n_inherited, int pointNum , double w_inertial, double w_social, double w_cognitive, double obs_factor,int max_speed,int initposmode ,bool pub_particles,int max_iter);
    ~PSO();
